...
<template>
     <form class="m-1 p-1">
        <input @keyup.enter="handleAddItem" class="mr-5 p-2 border-2 border-stone-200 rounded-md"  v-model="NewItem" placeholder="新增待辦事項..." >
      ...
      <div>
      <span class="text-pink-600 ml-35">待辦事項數量: {{ ItemList.length }}/{{ maxTodos }}</span>
    </div>
</template>